...
s826demo: s826_example.o lib826_64.a
	$(CC) $(CFLAGS) s826_example.o -o s826demo -lm -L./ -l826_64 -L./hiredis -lhiredis
else
...
s826_example.o: s826_example.c
	...
	$(CC) $(CFLAGS)  -Wall -Wextra -DOSTYPE_LINUX -c  s826_example.c -o s826_example.o -L./hiredis -lhiredis
